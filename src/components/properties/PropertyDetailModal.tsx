...
import {
    usePropertyWithRelationsByNameQuery,
                ...
                content={
                    <div className="flex flex-col gap-1.5 w-full text-sm">
                        ...
                        {ct.englishName ? (
                            <div className="text-xs text-zinc-500 dark:text-white/60">
                                公司名稱:{' '}
                                <span className="text-zinc-900 dark:text-white">{ct.englishName}</span>
                            </div>
                        ) : null}
                        {ct.tenancyNumber ? (
    ...
    return (
        <div className="fixed inset-0 z-60 flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className={`relative bg-white dark:bg-[#1a1a2e] w-full flex flex-col overflow-hidden shadow-2xl ${
                    isFullscreen
                        ? 'max-w-full h-full rounded-2xl'
                        : 'max-w-6xl max-h-[92vh] rounded-3xl'
                }`}
                onClick={(e) => e.stopPropagation()}
            >
                {/* Header */}
                <div className="shrink-0 flex items-center justify-between p-4 border-b border-zinc-200 dark:border-white/10">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-linear-to-br from-purple-500 to-blue-500 flex items-center justify-center text-white">
                            <Building2 className="w-5 h-5" />
                        </div>
                        <div>
                            <h2 className="text-lg font-bold text-zinc-900 dark:text-white">物業詳情</h2>
                            <p className="text-sm text-zinc-500 dark:text-white/50">{property?.name ?? propertyName}</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-1">
                        {/* 展開 / 收合按鈕 */}
                        <Tooltip content={isFullscreen ? '收合 (F11)' : '展開全螢幕 (F11)'} placement="bottom">
                            <button
                                type="button"
                                ...
                                aria-label={isFullscreen ? '收合' : '展開全螢幕'}
                            >
                                {isFullscreen ? (
                ...
                {isLoading ? (
                    ...
                    <div className="flex-1 overflow-hidden flex flex-row">
                        ...
                        <div className="hidden lg:flex lg:w-[40%] flex-col border-r border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-white/2">
                            <div className="flex-1 min-h-0 relative overflow-hidden">
                                {property.images && property.images.length > 0 && !imageError ? (
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center gap-2 h-full">
                                        ...
                                        <p className="text-zinc-400 dark:text-white/30 text-sm">暫無圖片</p>
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col flex-1 min-h-0 lg:w-[60%]">
                            {/* Top section: Property name + code + status + address */}
                            <div className="shrink-0 p-4 pb-0">
                                ...
                                {property.address ? (
                                    <div className="flex items-start gap-2 text-zinc-600 dark:text-white/65 text-sm mt-3">
                                        <MapPin className="w-4 h-4 shrink-0 mt-0.5" />
                                        <span>{property.address}</span>
                                    </div>
                                ) : (
                                    <div className="flex items-start gap-2 text-zinc-400 dark:text-white/35 text-sm mt-3">
                                        <MapPin className="w-4 h-4 shrink-0 mt-0.5" />
                            ...
                            <div className="shrink-0 px-4 py-3">
                                <div className="rounded-xl border border-zinc-200 dark:border-white/15 p-1 flex flex-wrap justify-start gap-1 bg-zinc-50/80 dark:bg-white/4">
                                    {mainTabs.map((tab) => (
                                        <button
                                            key={tab.id}
                                            type="button"
                                            onClick={() => setMainTab(tab.id)}
                                            className={`px-3 sm:px-4 py-1.5 rounded-lg text-sm font-medium transition-all ${mainTab === tab.id
                                ...
                                <div className="flex flex-col gap-5 pb-4">
                                    {mainTab === 'overview' && (
                                        <>
                                            ...
                                            {/* Notes Section */}
                                            <div className="p-2.5 border-l-[3px] border-purple-500 bg-purple-500/5 rounded-r-xl">
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                                <div className="bg-white dark:bg-white/5 rounded-2xl border border-zinc-200 dark:border-white/10 p-4 shadow-sm dark:shadow-none min-w-0 overflow-hidden">
                                                    ...
                                                    {proprietor ? (
                                                        <div className="flex items-center gap-3 min-w-0">
                                                            <div className="w-10 h-10 shrink-0 rounded-full bg-linear-to-br from-purple-500 to-blue-500 flex items-center justify-center text-white font-semibold text-sm">
                                                                {proprietor.name.charAt(0).toUpperCase()}
                                                            </div>
                                                            <div className="min-w-0 flex-1 overflow-hidden">
                                                                <p
                                                                    className="text-zinc-900 dark:text-white font-medium text-sm truncate"
                                                                ...
                                                                {proprietor.code ? (
                                                                    <p
                                                                        className="text-zinc-500 dark:text-white/50 text-xs font-mono truncate"
                                                ...
                                                <div className="bg-white dark:bg-white/5 rounded-2xl border border-zinc-200 dark:border-white/10 p-4 shadow-sm dark:shadow-none min-w-0 overflow-hidden">
                                                    ...
                                                    {subLandlordCard ? (
                                                        <div className="flex items-center gap-3 min-w-0">
                                                            <div className="w-10 h-10 shrink-0 rounded-full bg-linear-to-br from-amber-500 to-orange-500 flex items-center justify-center text-white font-semibold text-sm">
                                                ...
                                                <div className="bg-white dark:bg-white/5 rounded-2xl border border-zinc-200 dark:border-white/10 p-4 shadow-sm dark:shadow-none min-w-0 overflow-hidden">
                                                    ...
                                                    {propertyCurrentTenantDisplay ? (
                                                        <div className="flex items-center gap-3 min-w-0">
                                                            <div className="w-10 h-10 shrink-0 rounded-full bg-linear-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white font-semibold text-sm">
                                            ...
                                            {/* Rent History with 4 tabs */}
                                            <div className="bg-white dark:bg-white/5 rounded-2xl border border-zinc-200 dark:border-white/10 p-4 shadow-sm dark:shadow-none">
                                                ...
                                                {(() => {
                                                    ...
                                                    return (
                                                        <div className="overflow-x-auto">
                                                            <div className={isRentingTab ? 'min-w-175' : 'min-w-160'}>
                                                                <div
                                                                ...
                                                                <div className="divide-y divide-zinc-200 dark:divide-white/10">
                                                                    {pageList.map((rent: Rent) => {
                                                                        ...
                                                                        return (
                                                                            <div
                                                                                key={rent.id}
                                                                                className={`grid ${historyRowGrid} gap-0 hover:bg-zinc-50/50 dark:hover:bg-white/2 transition-colors items-stretch cursor-pointer`}
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <div className="py-4 px-4 border-l border-dashed border-zinc-200 dark:border-white/10 flex flex-col justify-center min-w-0 overflow-hidden">
                                                                                    <div
                                                                                        className="text-sm text-zinc-600 dark:text-white/70 leading-relaxed"
                                                                                        title={
                                    ...
                                    {mainTab === 'location' && (
                                        <div className="rounded-2xl border border-zinc-200 dark:border-white/10 overflow-hidden bg-zinc-50 dark:bg-white/5">
                                            <div className="h-50 sm:h-[250px] relative">
                                            ...
                                            {property.address ? (
                                                <div className="p-3 text-sm text-zinc-600 dark:text-white/70 flex items-start gap-2 border-t border-zinc-200 dark:border-white/10">
                                                    <MapPin className="w-4 h-4 shrink-0 mt-0.5" />
                                                    <span>{property.address}</span>
                                                </div>
                                            ) : null}
                                            ...
                                            <div className="bg-white dark:bg-white/5 rounded-2xl border border-zinc-200 dark:border-white/10 p-4 shadow-sm dark:shadow-none">
                                                ...
                                                {property.googleDrivePlanUrl ? (
                                                    <a
                                                        ...
                                                        className="flex items-center gap-2 px-3 py-2.5 bg-zinc-100 dark:bg-white/5 rounded-xl text-zinc-900 dark:text-white hover:bg-zinc-200 dark:hover:bg-white/10 transition-colors border border-zinc-200 dark:border-none text-sm"
                                                    >
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-zinc-400 dark:text-white/50">
                ...
                {/* Footer */}
                <div className="shrink-0 p-4 border-t border-zinc-200 dark:border-white/10 bg-zinc-50/50 dark:bg-white/2 flex justify-end">
                    <button
                        onClick={onClose}
                        className="px-5 py-2.5 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-xl font-medium hover:opacity-90 transition-opacity"
                    >
                        關閉
                    </button>
                </div>
